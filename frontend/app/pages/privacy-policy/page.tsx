    ...
    <div className="flex justify-center items-center p-6 bg-gray-50">
      <div className="max-w-3xl w-full bg-white p-6 rounded-lg shadow-lg">
        ...
        <section>
          ...
          <p className="text-lg text-gray-600 mb-6">
            If you have any questions or concerns about this Privacy Policy, please contact us at <a href="mailto:hi@BlinkShare.com" className="text-blue-500">hi@BlinkShare.com</a>.
          </p>
        </section>
