    ...
    <div className="w-full min-h-screen mt-16 flex justify-evenly items-center bg-gray-100 transition-colors duration-300 ease-in-out">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 w-full">
        <div className="col mb-4 px-4 text-center">
          <h1 className="text-3xl font-bold text-center mb-6 mt-12 bg-blink-green/70 p-4 rounded-lg shadow-lg inline-block">BlinkShare Embedded Wallet</h1>
          {(!ready || !authenticated) &&
                ...
                <div className="flex items-center mb-4">
                  <div>
                    ...
                    <AlertDescription className="mt-2">
                      BlinkShare requires you to connect your Discord in order to create your own embedded wallet
                    </AlertDescription>
                  </div>
                </div>
                <Button
                  onClick={onInitOAuth}
                  className="w-fit h-10 sm:h-12 bg-gray-900 text-white font-bold py-2 px-4 sm:px-6 rounded-md transition duration-300 ease-in-out transform hover:bg-gray-950 hover:scale-105 focus:outline-none focus:ring-2 focus:ring-gray-800 focus:ring-opacity-50"
                >
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 flex justify-center items-center">
        ...
        {/* //gray */}
        <motion.div
          className="absolute top-1/4 xl:top-10 left-0 w-14 sm:w-12 md:w-16 lg:w-20 xl:w-24 h-10  lg:h-20 bg-gray-100 z-1"
...
const faq = [
  {
    ...
    answer: (
      <div>
        Embedded wallets are self-custodial wallets provisioned by <a href="https://www.privy.io" target="_blank" className="text-gray-700 cursor-pointer">Privy</a>, directly integrated into an application instead of a separate wallet client. They allow users to interact with blockchain features without needing a separate wallet such as a browser extension or a mobile app. They provide a seamless experience for users who may not have an external wallet or want to avoid the complexity of managing crypto wallets.{" "}
        <a href="https://docs.privy.io/guide/react/wallets/overview#embedded-wallets" target="_blank" className="text-gray-700 cursor-pointer">
          Learn more
        </a>
      </div>
    ),
  },
  {
    ...
    answer: (
      <div>
        ...
        <a href="https://docs.privy.io/guide/react/wallets/overview" target="_blank" className="text-gray-700 cursor-pointer">
          Learn more
        </a>
      </div>
    ),
  },
  {
    ...
    answer: (
      <div>
        ...
        <br />
        By providing delegated access to BlinkShare, users can perform Solana transactions on Discord without needing to explicitly review and approve transactions each time. <br />
        <a href="https://docs.privy.io/guide/server/wallets/delegated-actions/" target="_blank" className="text-gray-700 cursor-pointer">
          Learn more
        </a>
      </div>
    ),
