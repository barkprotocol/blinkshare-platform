...
client.on(Events.GuildCreate, async (guild: Guild) => {
  console.info(`blinkshare has been added to the guild ${guild.name}`);
...
client.on(Events.InteractionCreate, async (interaction) => {
  ...
  const subcommandName = commandName === 'blinkshare' ? interaction.options.getSubcommand() : commandName;
